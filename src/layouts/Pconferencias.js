...
export default function Pconfeencias() {
      ...
      <Grid container direction="column" justify="center" alignItems="center"  style={{
        ...
        <GridListTile key="Subheader" cols={3} style={{ height: 'auto' }}>
          <ListSubheader component="div">
            <Info titulo={"Conferencias"} contenido={"En sisei tratamos de ofrecerte las mejores conferencias para que puedas tomar la decisión de cómo mejorar tu futuro y adaptarte a las necesidades del mercado actual."}/>
            </ListSubheader>
        </GridListTile>
          {tileData.map((tile) => (
